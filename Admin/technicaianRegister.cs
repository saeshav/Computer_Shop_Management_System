...
{
    public partial class technicaianRegister : Form
    {
        public technicaianRegister()
        {
            InitializeComponent();
        }

        private void technicaianRegister_Load(object sender, EventArgs e)
        {
        ...
        private void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            if (flag1 == true && flag2 == true && flag3 == true && flag4 == true && flag5 == true)
            {
                ...
                register.register_role("technician");
            }
        }
    }
}
